...
Last updated: Tue, 14 Jan 2020 19:02:44 GMT
...
### _Question:_ Which effects are abilities?
<a name="37"></a>

_Answer:_ An ability is text from a card a player controls (such a ship card, upgrade card, damage card, remote card, device, condition card, etc).
...
### _Question:_ What is meant by a "requirement" for an ability?
<a name="38"></a>

_Answer:_ A requirement for an ability is a conditional if-statement, such as "if you are tractored" or "if the defender is in your bullseye arc." A ship being in-arc at range for an attack made as part of a triggered ability, such as Snap Shot or Foresight, is also a requirement for that ability.
...
### _Question:_ When is the cost for an ability paid?
<a name="39"></a>

_Answer:_ The cost for an ability is paid when the ability is resolved.
...
### _Question:_ When specifically during an attack do effects that apply "while you perform an attack" or "while you defend" apply?
<a name="40"></a>

_Answer:_ Abilities are applied at the step in the attack at which they take effect. For example, in the case of Predator, as this is a dice modification, it is applied at Step 2b: Modify Attack Dice. Note, however, that effects resolved during Step 2b: Modify Attack Dice and 3b: Modify Defense Dice do not use the ability queue, as they are resolved in the order described in that section of the rules reference.



### _Question:_ If a ship executes a stationary maneuver in arc at range 2 of an enemy ship with Snap Shot equipped (or in the bullseye arc of an enemy ship with Foresight equipped), can the ship with Snap Shot (or Foresight) perform the bonus attack?
<a name="41"></a>
...
### _Question:_ While "Scourge" Skutu performs an attack using Snap Shot, if the defender is in "Scourge" Skutu's bullseye arc, does "Scourge" Skutu add an additional attack die?
<a name="42"></a>
...
### _Question:_ If a ship with Fine-Tuned Controls (or another ability that triggers "after you execute/fully execute a maneuver") fully executes a maneuver in arc at range 2 of a ship equipped with Snap Shot, how is this resolved?
<a name="43"></a>

_Answer:_ This is resolved one of several ways depending on which player is first player.
...
### _Question:_ After a Nantex-class starfighter executes its maneuver, if it uses its Pinpoint Tractor Array ship ability to assign a tractor token to itself so that it can rotate its turret arc, and then it barrel rolls itself over a debris field as a result of becoming tractored, giving it a stress token, how does this resolve?
<a name="45"></a>

_Answer:_ After a Nantex-class starfighter executes its maneuver, it has the option to add an ability in the queue with the effect of "gain 1 tractor token to perform a [Rotate] action."
...
### _Question:_ Can Snap Shot or Foresight be chosen as a special weapon to be used for a ship's attack during the Engagement Phase?
<a name="46"></a>

_Answer:_ Yes. The phrase "after an enemy ship executes a maneuver, you may perform this attack against it as a bonus attack" allows the attack to be used as a bonus attack under the specified circumstances, but does not disqualify it from being used during the Engagement Phase.
